...
You'll need to learn about eBPF (extended Berkley Packet Filters), and how to use them to instrument the execution of the code. Then, you'll run experiments to measure the impact on communitacition latency and bandwidth.
